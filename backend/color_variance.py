...
img_idx = 1
img = cv2.imread(f"./test_images/{images[img_idx]}")
alpha_mask = create_alpha_matting_mask(img, threshold_method="mean_std")
cv2.imwrite(f"./result_images/color_variance/{images[img_idx]}", alpha_mask)
